export default async function sitemap() {
  ...
  const staticEntries = [
    ...
    { url: `${base}/about`, changefreq: 'monthly', priority: 0.8, lastModified: now },
    { url: `${base}/contact`, changefreq: 'monthly', priority: 0.7, lastModified: now },
  ]

  // Bütün xidmətləri sitemap-a əlavə et
